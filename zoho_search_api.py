...
def build_search_key(subject_contains, attachment_contains, sender_contains, content_contains, since_date, require_attachment):
    ...
    if since_date:
        try:
            ...
            # Zoho 的 fromDate 要求 DD-MMM-YYYY 这种格式，比如 17-Aug-2026
